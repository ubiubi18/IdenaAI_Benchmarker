    ...
    const invokeProvider = jest
      ...
      .mockResolvedValueOnce({
        rawText: JSON.stringify({
          final_story_title: 'Safe literal flow',
          story_summary:
      ...
      .mockResolvedValueOnce({
        rawText: JSON.stringify({
          final_story_title: 'Safer literal flow',
          story_summary:
        ...
        stories: [
          {
            ...
            panels: [
              ...
              'The clown positions the log and checks protective gear.',
              'The clown safely carves the log with the chainsaw.',
              'The clown shows the finished sculpture on the workbench.',
            ],
          },
          {
            title: 'Option 2',
            panels: [
              'A clown arrives at an outdoor carving booth with a chainsaw.',
              'The clown starts shaping a wooden block.',
              'The carving takes form as the chainsaw remains visible.',
              'The clown presents the completed wooden figure.',
            ],
          },
        ],
      }),
    ...
    const invokeProvider = jest.fn().mockResolvedValue({
      rawText: JSON.stringify({
        stories: [
          {
            title: 'Option 1',
            story_summary: 'A person waters a plant and it grows.',
            panels: [
              'A person places a dry plant on a table.',
              'The person pours water into the pot.',
              'The stem rises and leaves open.',
              'The plant stands healthy and taller.',
            ],
          },
          {
            title: 'Option 2',
            story_summary: 'A person repots a plant and it stabilizes.',
            panels: [
              'A person lifts a weak plant from a small pot.',
              'The person moves it into a larger pot with soil.',
              'The roots settle as soil is pressed in.',
              'The plant stands upright in the new pot.',
            ],
          },
        ],
      }),
