          ...
          <Stack spacing={4}>
            ...
            <Stack isInline justify="flex-start" spacing={2} align="center">
              ...
              <SecondaryButton
                ...
                onClick={async () => {
                  ...
                  try {
                    const providers = PROVIDER_OPTIONS.map((item) => item.value)
                    let loaded = 0
                    let failed = 0
            ...
            <Flex align="center" justify="space-between">
              ...
              <Switch
                ...
                onChange={() =>
                  updateAiSolverSettings({
                    legacyHeuristicEnabled: !aiSolver.legacyHeuristicEnabled,
                  })
                }
              />
            </Flex>
            ...
            {aiSolver.legacyHeuristicEnabled && (
              <Stack spacing={3}>
                ...
                <Flex align="center" justify="space-between">
                  <Box>
                    <Text fontWeight={500}>{t('Legacy-only run mode')}</Text>
                    <Text color="muted" fontSize="sm">
                      {t(
            ...
            {aiSolver.ensembleEnabled && (
              <Stack spacing={3} borderWidth="1px" borderColor="gray.100" p={3}>
                <Text color="muted" fontSize="sm">
                  {t(
            ...
            {aiSolver.benchmarkProfile === 'custom' && (
              <Stack spacing={3}>
                ...
                <Flex align="center" justify="space-between">
                  <Box>
                    <Text fontWeight={500}>{t('Uncertainty second pass')}</Text>
                    <Text color="muted" fontSize="sm">
                      {t(
                ...
                {aiSolver.uncertaintyRepromptEnabled && (
                  <>
                    ...
                    <SettingsFormControl>
                      ...
                      <Input
                        value={aiSolver.uncertaintyRepromptInstruction || ''}
                        onChange={(e) =>
                          updateAiSolverSettings({
